...
namespace OpenLibrary.Models
{
    public  class SachModel
    {
        ...
        public int ThemSach(string ten_sach,int id_tac_gia,string doc_thu,int id_loai_sach,
                            int id_nha_xuat_ban,string gioi_thieu,string sku,int trong_luong,
        ...
        public int CapNhatSachTheoID(int id , string ten_sach, int id_tac_gia, string doc_thu, 
                                     int id_loai_sach, int id_nha_xuat_ban,string gioi_thieu, 
                                     string sku, int trong_luong, int trang_thai, string hinh, 
